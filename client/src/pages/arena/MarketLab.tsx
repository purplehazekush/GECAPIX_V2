...
const REGIME_PRESETS: Record<number, { name: string, params: PhysicsParams }> = {
    0: { name: 'BAIXISSIMO RUIDO - SEM DRIFT - BAIXO CAOS - VOLATILIDADE BAIXA - ENTRADA DE OPERACAO -', params: { drift: 0, dampening: 0.004, insensitiveness: 0.000001, noise: 0.6 } },
    1: { name: 'DRIFT CRESCENDO EXPONENCIAL - PUMP SEM PULLBACK - SEM RUIDO', params: { drift: 0.0035, dampening: 0.00015, insensitiveness: 0.0000001, noise: 0.6 } },
    2: { name: 'DRIFT CRESCENDO EXPONENCIAL - ALTO RUIDO', params: { drift: 0.0005, dampening: 0.02, insensitiveness: 0.0000001, noise: 0.03 } },
