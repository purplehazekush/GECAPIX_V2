                                ...
                                {msg.arquivo_url && (
                                    <div className="mt-2">
                                        {msg.tipo_arquivo === 'imagem' ? (
                                            <img src={msg.arquivo_url} className="rounded-lg max-h-40 border border-black/20" />
                                        ) : (
                                            <a href={msg.arquivo_url} target="_blank" className="flex items-center gap-2 bg-black/20 p-2 rounded-lg hover:bg-black/40">
                                                <PictureAsPdf className="text-red-400" />
                                                <span className="text-xs underline">Ver Documento</span>
                                            </a>
                                        )}
                                    </div>
                                )}
