...
export default function Admin() {
  ...
  const promoverAdmin = async (email: string) => {
    const confirmacao = window.confirm(`Tem certeza que deseja tornar ${email} um ADMINISTRADOR? Ele terá acesso total.`);
    ...
    <div className="pb-24 animate-fade-in space-y-8 max-w-4xl mx-auto px-4">
      ...
      <div className="glass-panel p-6 rounded-xl border border-yellow-500/20">
        <div className="flex items-center gap-2 mb-6 border-b border-slate-700 pb-4">
            ...
            <h2 className="text-xl font-bold text-yellow-500">Membros & Permissões</h2>
        </div>
