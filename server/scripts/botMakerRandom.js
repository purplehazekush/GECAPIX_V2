// server/scripts/botMakerRandom.js
...
async function runBot() {
    ...
    setInterval(async () => {
        const isBuying = Math.random() > 0.515; // 5% chance de compra
        const amount = Math.floor(Math.random() * 2) + 1; // 1 a 4 tokens
